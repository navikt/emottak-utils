    ...
    StringSpec(
        {
            ...
            beforeSpec {
                ...
                val responses: Map<String, String> =
                    mapOf(
                        serviceuserVaultPath to
                            "{\"data\": {\"data\": {\"username\":\"srv-ebms-payload\", \"password\":\"srv-ebms-payload-password\"}}}",
            ...
            "Should throw RuntimeException when requested resource not found" {
                ...
                exception.message shouldBe
                    "Failed to read vault path resource: '$credentialVaultPath/non-existing-resource'. Available keys: [password, username]"
            }
        },
    )
